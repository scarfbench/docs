...
<p align='center'>
  <a href="https://github.com/scarfbench/benchmark" class="md-button" target="_blank" rel="noopener noreferrer">
    <svg style="width: 66px; height: 66px; vertical-align: middle; margin-right: 0.5rem;" viewBox="0 0 24 24" fill="currentColor">
