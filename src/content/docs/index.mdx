...
<div class="sb-logo">
  <img id="sb-theme-logo" src="/docs/assets/images/scarf-dark.png" alt="ScarfBench" />
</div>
  ...
  (() => {
    ...
    const updateLogo = () => {
      ...
      logo.setAttribute(
        'src',
        theme === 'light'
          ? '/docs/assets/images/scarf-light.png'
          : '/docs/assets/images/scarf-dark.png'
      );
    };
...
<p align='center'>
  <a href="https://github.com/scarfbench/benchmark" style="display: inline-block; line-height: 0;" target="_blank" rel="noopener noreferrer" aria-label="ScarfBench on GitHub">
    <svg style="width: 66px; height: 66px; vertical-align: middle;" viewBox="0 0 24 24" fill="currentColor">
...
<div class="sb-note-box">
  <strong>Manual Conversions with Developer Verification</strong>
...
<CardGrid>
  <a class="sb-grid-card-item" href="/docs/quickstart/">
    <strong>Quickstart</strong>
        Run through an example to quickly set up Scarfbench and evaluate agentic solutions.
  </a>
    
  <a class="sb-grid-card-item" href="/docs/installing/">
    <strong>Installing ScarfBench</strong>
        Run through an example to quickly set up Scarfbench and evaluate agentic solutions.
  </a>
    
  <a class="sb-grid-card-item" href="/docs/leaderboard/">
  <strong>Getting Started</strong>
        Run through an example to quickly set up Scarfbench and evaluate agentic solutions.
  </a>

  <a class="sb-grid-card-item" href="/docs/submit/">
    <strong>Submit Solutions</strong>
        Run through an example to quickly set up Scarfbench and evaluate agentic solutions.
  </a>
</CardGrid>
